...
export default async function NewExpensePage() {
  ...
  // Тащим последние 50 активных заказов для опции привязки
  ...
  const orderOptions = orders.map(o => ({
    ...
    service_title: o.service_id
      ? (serviceNames.get(o.service_id) ?? '—')
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-semibold mb-4">Новый расход</h1>
