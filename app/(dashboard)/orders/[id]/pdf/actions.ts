...
async function getMessages() {
  ...
  return locale === 'de'
    ? {
        ...
        fillClient: 'Für die Rechnung bitte beim Kunden ausfuellen',
        missingPrice: 'Preis des Auftrags ist nicht angegeben',
        missingSourceInvoice: 'Ausgangsrechnung für die Korrektur konnte nicht gefunden werden',
        unauthorized: 'Nicht autorisiert',
        orderNotFound: 'Auftrag nicht gefunden',
        invoiceLocked:
          'Die Rechnung wurde bereits erstellt und fixiert. Eine Neugenerierung über das Ausgangsdokument ist gesperrt. Für Änderungen ist eine separate Rechnungskorrektur erforderlich.',
