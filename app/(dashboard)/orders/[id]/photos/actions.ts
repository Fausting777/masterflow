...
async function getMessages() {
  ...
  return locale === 'de'
    ? {
        ...
        invalidType: 'Ungültiger Fototyp',
        fileMissing: 'Datei wurde nicht ausgewählt',
        ...
        locked: 'Nach der Rechnungsausgabe können PDF-relevante Fotos nicht mehr geändert werden',
    ...
    : {
        ...
        locked: 'После выпуска счета нельзя менять фото, влияющие на архивный PDF',
