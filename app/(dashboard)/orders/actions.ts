...
function getMessages(locale: UiLocale) {
  if (locale === 'de') {
    return {
      ...
      invoiceEditBlocked: 'Dieser Auftrag ist bereits mit einer Rechnung verknuepft. Originaldaten koennen nicht mehr direkt bearbeitet werden. Verwenden Sie stattdessen eine Rechnungskorrektur.',
      ...
      correctionNeedsInvoice: 'Ein Korrekturentwurf kann erst erstellt werden, wenn fuer den Auftrag bereits eine Rechnung existiert.',
      ...
      cannotDeleteInvoice: 'Endgueltiges Loeschen ist nicht moeglich, weil fuer diesen Auftrag bereits eine Rechnung erstellt wurde.',
