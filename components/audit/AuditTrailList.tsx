...
const FIELD_LABELS: Record<string, { ru: string; de: string }> = {
  ...
  completed_at: { ru: 'завершён', de: 'abgeschlossen' },
  ...
  invoice_sent_at: { ru: 'отправлен', de: 'versendet am' },
  invoice_sent_to: { ru: 'отправлен на', de: 'versendet an' },
  invoice_snapshot_json: { ru: 'snapshot счёта', de: 'Rechnungs-Snapshot' },
  invoice_version: { ru: 'версия счёта', de: 'Rechnungsversion' },
  order_address: { ru: 'адрес работ', de: 'Arbeitsadresse' },
