...
const FIELD_LABELS: Record<string, { ru: string; de: string }> = {
  ...
  invoice_issued_at: { ru: 'дата квитанции', de: 'Quittungsdatum' },
  invoice_locked_at: { ru: 'блокировка квитанции', de: 'Quittungssperre' },
  invoice_number: { ru: 'номер квитанции', de: 'Quittungsnummer' },
  invoice_sent_at: { ru: 'отправлено', de: 'versendet am' },
  invoice_sent_to: { ru: 'отправлено на', de: 'versendet an' },
  invoice_snapshot_json: { ru: 'snapshot квитанции', de: 'Quittungs-Snapshot' },
  invoice_version: { ru: 'версия квитанции', de: 'Quittungsversion' },
