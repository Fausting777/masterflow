  ...
  const text =
    locale === 'de'
      ...
      : {
          ...
          draftLocked:
            'После выпуска счёта PDF фиксируется. Повторно пересоздать его поверх исходного документа больше нельзя.',
          draftHint:
            'До выпуска счёта PDF можно пересоздать, если ты изменил данные или добавил фото.',
          generating: 'Генерация PDF...',
          generatePdf: 'Создать PDF-Rechnung',
